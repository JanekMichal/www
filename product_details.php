        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 mt-4">
                    ...
                    <div class="mt-3">
                        <label for="validationCustom04">Rozmiary: </label>
                        <select name="size" class="form-control" id="validationCustom04" required>
                            <?php
                            ...
                            echo " <option value=''> 40 - $size40_stock szt.  </option> ";
                            echo " <option value=''> 41 - $size41_stock szt.  </option> ";
                            echo " <option value=''> 42 - $size42_stock szt.  </option> ";
                            echo " <option value=''> 43 - $size43_stock szt.  </option> ";
                            echo " <option value=''> 44 - $size44_stock szt.  </option> ";
                            echo " <option value=''> 45 - $size45_stock szt.  </option> ";
                            echo " <option value=''> 46 - $size46_stock szt.  </option> ";
                   ...
                   <div class="mt-3">
                       <button type="button" class="btn btn-outline-success"><i class="fas fa-shopping-cart"></i>
